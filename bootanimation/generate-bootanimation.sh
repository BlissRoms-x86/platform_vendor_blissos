...
IMAGESCALEHEIGHT=$(expr $IMAGESCALEWIDTH / 1)

IMAGEHEIGHT=$(expr $IMAGEWIDTH / 1)
...
tar xfp "vendor/blissos/bootanimation/bootanimation.tar" -C "$BOOTANIOUT/bootanimation/"
...
cat "vendor/blissos/bootanimation/desc.txt" >> "$BOOTANIOUT/bootanimation/desc.txt"
